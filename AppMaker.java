...
public class AppMaker extends Frame implements ActionListener, ItemListener, MouseListener, KeyListener {
   ...
   //============================
    //--- Control Creators -------
    //============================
    public Button addButton(String text, int left, int top, int width, int height, ActionListener listener) {
    ...
    public TextField addTextField(String text, int left, int top, int width, int height, ActionListener listener) {
    ...
    public TextArea addTextArea(String text, int left, int top, int width, int height, KeyListener listener) {
    ...
    public Label addLabel(String text, int left, int top, int width, int height, MouseListener listener) {
